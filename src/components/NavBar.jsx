            ...
            <div className="flex justify-between w-8/12 mx-auto p-3 max-w-[1080px]">
                ...
                <NavLink to="/">
                    <div className="flex items-center gap-x-1">
                        ...
                        <div>
                            <h2 className="underline text-[#5e9c6a] text-2xl font-bold">ECOMZY</h2>
                        </div>
                    </div>
                </NavLink>
                ...
                <div className="flex items-center gap-x-6">
                    ...
                    <NavLink to="/cart">
                        <div className="w-6 h-6 relative">
                                <div className="w-4 h-4 bg-red-800 rounded-full absolute right-[-0.3rem] top-[-0.4rem]"></div>  
                                <div className="absolute top-[-0.6rem] right-0 text-white text-sm">{itemCount}</div>
